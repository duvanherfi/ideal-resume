...
import { ContactSection, MainColumn, ProfileHeader, SideColumn } from '../sections/TemplateElegant.sections';
import styleBuilder from '../styles/TemplateElegant.styles';
