...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="backdrop-blur-md hidden lg:sticky border-t border-secondary-900/20 dark:border-secondary-500/20 bottom-0 bg-white/30 text-black dark:bg-black/70 dark:text-secondary-100 py-4">
