...
const TabList: React.FC<TabListProps> = (props: TabListProps) => {
  ...
  return (
    <div className={`w-full flex justify-start md:justify-between ${className} bg-white/70 backdrop-blur-xl dark:bg-black/50 rounded-tr-lg rounded-tl-lg overflow-x-auto scrollbar`}>
