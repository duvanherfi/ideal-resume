...
const Header: React.FC = () => {
  return (
    <header className="lg:px-12 flex justify-between items-center fixed top-0 z-50 backdrop-blur-xl w-full py-2 px-3 bg-white/50 text-secondary-900 dark:bg-black/50 dark:text-secondary-100 border-b border-secondary-900/20 dark:border-secondary-500/20 h-16">
