...
const common = (theme: TemplateTheme): CommonStyles => ({
    ...
    badge: {
        container: {
            ...
            paddingHorizontal: 6,
            borderRadius: 4,
            backgroundColor: `${theme.color.all || theme.color.badge}33`, // 20% opacity
...
const project = (theme: TemplateTheme): ProjectStyles => ({
    ...
    item: {
        padding: 6,
        marginBottom: 8,
        backgroundColor: `${theme.color.all || theme.color.primary}10`, // 6% opacity
        borderRadius: 4,
    },
    name: {
        fontSize: 10,
...
const skill = (theme: TemplateTheme): SkillStyles => ({
    ...
    item: {
        backgroundColor: `${theme.color.all || theme.color.skill}20`,
        paddingVertical: 2,
        paddingHorizontal: 6,
        borderRadius: 4,
    },
    name: {
        fontSize: 8,
        color: theme.color.all || theme.color.skill,
        fontWeight: 600 as const,
    },
    bar: {
        container: {},
