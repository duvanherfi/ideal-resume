...
const ViewTemplatePreview = () => {
    ...
    return (
        <GlassCard className={`overflow-y-hidden bg-primary-200/50 dark:bg-black/30 border-primary-500/30 dark:border-secondary-500/20 backdrop-blur-xl shadow-md w-full mx-auto border-l-2 h-full`}>
