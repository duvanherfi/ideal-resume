        ...
        <>
            ...
            {isOpen && (
                <div className="transition-all duration-500 fixed inset-0 backdrop-blur-sm flex items-center justify-center z-50 w-auto" onClick={handleOutsideClick}>
                    <div className={`dark:border-primary-500/20 border-primary-500/30 bg-white dark:bg-black/ backdrop-blur-xl rounded-lg shadow-xl p-6 w-full max-w-6xl mx-4 transform transition-all duration-300 ${modalClassName}`}>
