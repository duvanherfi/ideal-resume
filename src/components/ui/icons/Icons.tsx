...
const Icons = {
    ...
    Palette: () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 512 512" fill="currentColor">
            <path d="M429.76,319.24c0-45.28-36.5-82.37-82.32-82.37a82.4,82.4,0,0,0-16.82,1.73A88,88,0,1,0,215.54,384l.06-.09A121.71,121.71,0,0,0,256,386.8c53.18,0,97.68-33.49,115.47-80.21a42.25,42.25,0,0,0,58.29-39.35ZM128,160a32,32,0,1,1-32,32A32,32,0,0,1,128,160Zm80-32a32,32,0,1,1-32,32A32,32,0,0,1,208,128ZM384,96a32,32,0,1,1-32,32A32,32,0,0,1,384,96Zm-64,32a32,32,0,1,1-32,32A32,32,0,0,1,320,128Zm-80,64a32,32,0,1,1-32,32A32,32,0,0,1,240,192ZM256,0C114.84,0,0,114.84,0,256S114.84,512,256,512,512,397.16,512,256,397.16,0,256,0Zm0,480C132.29,480,32,379.71,32,256S132.29,32,256,32,480,132.29,480,256,379.71,480,256,480Z" />
        </svg>
    )
};
