...
const Select: React.FC<SelectProps> = ({ label, name, value, onChange, options }) => {
    ...
    const optionClassName = "transition-all duration-200 w-full px-3 py-2 dark:text-white bg-white/50 dark:bg-black border dark:border-secondary-700 border-secondary-300 rounded-lg shadow-sm backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500";
